...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if (AppDelegateInstance.defaultUser!=nil) {
        [self.avatar sd_setImageWithURL:[NSURL URLWithString:AppDelegateInstance.defaultUser.member_avatar]];
        self.name.text = AppDelegateInstance.defaultUser.member_name;
    }
}
