...
-(void)showMainPage
{
    ...
    [JPUSHService setTags:nil alias:[NSString stringWithFormat:@"%@",AppDelegateInstance.defaultUser.push_id]  callbackSelector:@selector(tagsAliasCallback:tags:alias:) object:self];
