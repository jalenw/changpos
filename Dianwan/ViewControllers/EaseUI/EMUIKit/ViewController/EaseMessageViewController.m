...
- (void)sendTextMessage:(NSString *)text withExt:(NSDictionary*)ext
{
    ...
    [parm setValue:@(AppDelegateInstance.defaultUser.member_id) forKey:@"userId"];
    [parm setValue:AppDelegateInstance.defaultUser.chat_id forKey:@"chatId"];
    [parm setValue:AppDelegateInstance.defaultUser.member_name forKey:@"nickName"];
    [parm setValue:AppDelegateInstance.defaultUser.member_avatar forKey:@"avatar"];
    if (self.ower) {
