...
-(void)getdata{
    ...
    [SVProgressHUD show];
    [[ServiceForUser manager]postMethodName:@"mobile/area/area_list" params:@{  @"client":@"ios"} block:^(NSDictionary *data, NSString *error, BOOL status, NSError *requestFailed) {
